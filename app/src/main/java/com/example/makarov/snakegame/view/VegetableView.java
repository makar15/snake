...
/**
 * Класс Vegetable которую будем отрисовывать в игре
 */
public class VegetableView implements View {
     ...
     */
    public VegetableView(FieldObject object, FieldProvider fieldProvider, IconLoader iconLoader){
        mObject = object;
        ...
        icon = mIconLoader.getIcon(IconLoader.TYPE_VEGETABLE, width, height);
    }
